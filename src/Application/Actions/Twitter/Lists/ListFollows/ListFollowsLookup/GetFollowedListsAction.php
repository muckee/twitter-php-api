...
namespace App\Application\Actions\Twitter\Lists\ListFollows\ListFollowsLookup;

use Psr\Http\Message\ResponseInterface as Response;

use App\Application\Actions\Twitter\Lists\ListsAction;

class GetFollowedListsAction extends ListsAction
{
  /**
   * {@inheritdoc}
   */
  protected function action(): Response
  {
    ...
    $uri = 'users' . '/' . $user_id . '/' . 'followed_lists';
